<template>
  ...
  <UploadLayout>
    ...
    >
      <div>
        <div class="text-[23px] font-semibold">Prześlij wideo</div>
        <div class="text-gray-400 mt-1">Opublikuj wideo na swoim koncie</div>
      </div>
      ...
      <div class="mt-8 md:flex gap-6">
        ...
        >
          ...
          <div class="mt-4 text-[17px]">Wybierz wideo do przesłania</div>
          <div class="mt-1.5 text-gray-500 text-[13px]">
            Lub przeciągnij i upuść plik
          </div>
          <div class="mt-12 text-gray-400 text-sm">MP4</div>
          <div class="mt-2 text-gray-400 text-[13px]">Do 30 minut</div>
          <div class="mt-2 text-gray-400 text-[13px]">Mniej niż 2 GB</div>
          <div
            class="px-2 py-1.5 mt-8 text-white text-[15px] w-[80%] bg-[#bc2cf0] rounded-sm"
          >
            Wybierz plik
          </div>
          <input
        ...
        <div class="mt-4 mb-6 w-full">
          <div class="mt-5">
            <div class="flex items-center justify-between">
              <div class="mb-1 text-[15px]">Napis</div>
          ...
          <div class="flex gap-3">
            ...
            <button
              @click="createPost()"
              class="px-10 py-2.5 mt-8 border text-[16px] text-white bg-[#bc2cf0] rounded-sm"
            >
              Opublikuj
            </button>
          </div>
