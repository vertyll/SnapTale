    ...
    >
      <div class="flex w-[calc(100vw-230px)]">
        ...
        <div class="ml-5 w-full">
          ...
          <!-- <button
              v-else
              class="flex item-center rounded-md py-1.5 px-8 mt-3 text-[15px] text-white font-semibold bg-[#bc2cf0]"
            >
              Śledź
            </button> -->
        </div>
      ...
      <div class="w-full flex items-center pt-4 border-b">
        ...
        <!-- <div
          ...
          >
            <Icon name="material-symbols:lock-open" class="mb-0.5" /> Polubione
          </div> -->
      </div>
