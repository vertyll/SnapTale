<template>
  ...
  >
    ...
    >
      ...
      >
        <div class="text-[22px] font-medium">Edytuj profil</div>
            ...
            <div class="flex items-center justify-center sm:-mt-6">
              <div class="sm:w-[60%] w-full max-w-md">
                ...
                <div class="text-[11px] text-gray-500 mt-4">
                  Nazwy użytkowników mogą zawierać tylko litery, cyfry,
                  podkreślenia i kropki. Zmiana nazwy użytkownika spowoduje
                  również zmianę linku do profilu.
                </div>
              </div>
            </div>
          </div>
      ...
      >
        ...
        >
          ...
          >
            <span class="px-2 font-medium text-[15px]">Anuluj</span>
          </button>

          <button
            :disabled="!isUpdated"
            @click="updateUserInfo()"
            :class="!isUpdated ? 'bg-gray-200' : 'bg-[#bc2cf0]'"
            class="flex items-center bg-[#bc2cf0] text-white border rounded-md ml-3 px-3 py-[6px]"
          >
            <span class="mx-4 font-medium text-[15px]">Zapisz</span>
          </button>
        </div>
